...
// npm run calculate https://rntbci.in/,https://www.nissan.in/
(async () => {
  if( process.argv[2] != undefined){
        ...
        for (let i = 0; i < urls.length; i++) {
          ...
          await page.authenticate({'username':'z031965', 'password': 'Flower44'});
        ...
        const latestFileName = "json/calc-latest.json";
      ...
      console.log('Please enter URL for monitoring')
      return
    }
})();
